...
<div class=" centered">
  <article class="letter">
    <div class="side p-5">
      ...
      <p>
        <textarea class="inputclass" placeholder="Your message"></textarea>
      </p>
    </div>
    <div class="side">
      <p>
        <input type="text"  class="inputclass" placeholder="Your name" >
      </p>
      <p>
        <input type="email"  class="inputclass" placeholder="Your email" >
      </p>
      <p>
        <button id="sendLetter"  class="inputclass">Send</button>
      </p>
    </div>
  </article>
...
<p class="result-message centered">Thank you for your message</p>
    ...
    <footer class="site-footer">
      ...
      <div class="text-right m-5 col-xl-8 col-lg-12 col-md-3 col-sm-4 " style="display: inline-block;">
      <a href="#" class="color">
Privacy policy </a>
      <a href="#" class="color">
&nbsp;&nbsp;&nbsp;
...
textarea, input {
  ...
  background-image: url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='10' height='24'><rect fill='rgb(242, 224, 212)' x='0' y='23' width='10' height='1'/></svg>");
}
textarea {
 width: 100%;
 height: 8rem;
...
input {
 ...
 margin-bottom: 1rem;
  &[type=text]:invalid, [type=email]:invalid {
    box-shadow: none;
    background-image: url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='10' height='24'><rect fill='rgba(242, 224, 212, 0.5)' x='0' y='23' width='10' height='1'/></svg>");
  }
}
button {
 padding: 0.5rem 1rem;
...
textarea:focus {
  background-image: url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='10' height='24'><rect fill='rgba(242, 224, 212, 0.3)' x='0' y='23' width='10' height='1'/></svg>");
  outline: none;
}
