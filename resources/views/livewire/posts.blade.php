      ...
      <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
          <div>
            ...
            <div>
                ...
                <div class="mb-2">
                    <label for="name" class="block">Na,e</label>
                    <input wire:model="name" type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-blue-900" placeholder="Input Post">
                    @error('name') <h1 class="text-red-500">{{$message}}</h1>@enderror
                </div>
                <div class="mb-2">
                    <label for="type" class="block">Type</label>
                    <textarea wire:model="type" name="type" class="shadow appearance-none border rounded w-full py-2 px-3 text-blue-900" placeholder="Input Post"></textarea>
                    @error('type') <h1 class="text-red-500">{{$message}}</h1>@enderror
                </div>
                <div class="mb-2">
                    <label for="status" class="block">Status</label>
                    <textarea wire:model="status" name="status" class="shadow appearance-none border rounded w-full py-2 px-3 text-blue-900" placeholder="Input Post"></textarea>
