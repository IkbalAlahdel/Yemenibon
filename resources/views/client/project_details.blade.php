    ...
    <div class="proj-container">
        <section id="main-content">
			...
			C280.838,180.918,253.549,312.392,219.598,441.896z" />
                                            ...
                                            <a class="business-card-link" href="{{$project->website}}"> 
                                            {{$project->website}}
		...
		z" />
                                            ...
                                            <a class="business-card-link" href="{{$project->email}}"> 
                                                {{$project->email}}
		...
		c6.225,8.141,9.022,17.33,13.93,26.094c2.12,3.786,9.229,2.391,8.654-2.344C174.998,27.742,151.979,8.645,130.69,1.147z" />
			...
			c115.519,3.728,263.06-4.237,376.791-2.262C420.668,160.78,425.025,295.631,422.258,430.486z" />
                                            ...
                                            <a class="business-card-link" href="{{$project->face_link}}"> 
                                                {{$project->face_link}}
			...
			c5.509,3.255,11.156,6.241,16.854,9.135C439.216,157.997,432.95,160.302,426.658,162.546z" />
                                            ...
                                            <a class="business-card-link" href="{{$project->twit_link}}"> 
                                                {{$project->twit_link}}
			...
			C256.591,265.212,246.324,250.709,231.146,243.564z" />
                                            ...
                                            <a class="business-card-link" href="{{$project->insta_link}}"> 
                                                {{$project->insta_link}}
